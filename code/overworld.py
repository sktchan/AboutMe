...
class Icon(pygame.sprite.Sprite):
	def __init__(self,pos):
		super().__init__()
		self.pos = pos
		self.image = pygame.image.load('/Users/Serena/PycharmProjects/GApp/graphics/character/head.png').convert_alpha()
		self.rect = self.image.get_rect(center = pos)
...
class Overworld:
	def __init__(self,start_level,max_level,surface,create_level):
		...
		self.setup_nodes()
		self.setup_icon()
		self.sky = Sky(800,'overworld')
		self.clouds = Clouds(800,30*64,50)
	...
	def draw_paths(self):
		if self.max_level > 0:
			...
			pygame.draw.lines(self.display_surface,'#8998b0',False,points,5)
